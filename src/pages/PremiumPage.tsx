...
const PremiumPage = () => {
  const features = ['Unlimited card scans', 'Export to multiple formats', 'AI-powered duplicate detection', 'Team collaboration', 'Priority support'];
  return <div className="flex items-center justify-center min-h-full p-6 bg-gradient-header rounded-sm shadow border-primary bg-destructive">
      <Card className="max-w-md w-full bg-card/80 backdrop-blur-sm border-border/50 p-8 text-center space-y-6">
        ...
        <Button size="lg" className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 text-white hover:from-yellow-600 hover:to-orange-600">
